...
**The Hive** — SatIO creates and stores a lot of different values from sensors and extrapolated from combinations of sensor data, that can be used by SatIO to switch I/O via programmable compounds of logic, and or can be simply passed out over serial for another device to read.
