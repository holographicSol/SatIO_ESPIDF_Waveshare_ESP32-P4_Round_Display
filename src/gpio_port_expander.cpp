...
// --------------------------------------------------------------------
static int8_t modulated_pin_list[MAX_GPIOPortExpander_ATMEGA2560_Default_PINS];
static int8_t modulated_pin_pos[MAX_GPIOPortExpander_ATMEGA2560_Default_PINS];
...
void activateModulatedPin(GPIOPortExpander *expander, int8_t idx) {
  if (idx < 0 || idx >= expander->max_pins || idx >= MAX_GPIOPortExpander_ATMEGA2560_Default_PINS) return;
...
void deactivateModulatedPin(GPIOPortExpander *expander, int8_t idx) {
  if (idx < 0 || idx >= expander->max_pins || idx >= MAX_GPIOPortExpander_ATMEGA2560_Default_PINS) return;
  ensureModulatedPinPosInit();
