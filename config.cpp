...
PwrConfig pwrConfigLowPower = {
    ...
    .TASK_MAX_FREQ_MULTIPLEXERS = TASK_MAX_FREQ_LOW_MULTIPLEXERS,
...
PwrConfig pwrConfigBalanced = {
    ...
    .TASK_MAX_FREQ_MULTIPLEXERS = TASK_MAX_FREQ_BALANCED_MULTIPLEXERS,
...
PwrConfig pwrConfigUltimatePerformance = {
    ...
    .TASK_MAX_FREQ_MULTIPLEXERS = TASK_MAX_FREQ_HIGH_MULTIPLEXERS,
