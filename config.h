...
#define INDEX_MATRIX_SWITCH_FUNCTION_GNGGA_VALID_CD 32
#define INDEX_MATRIX_SWITCH_FUNCTION_GNRMC_VALID_CD 33
#define INDEX_MATRIX_SWITCH_FUNCTION_GPATT_VALID_CD 34
